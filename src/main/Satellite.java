...
public class Satellite extends CorpsCeleste{
    ...
    public Satellite(int id,String name, int size, int revolution, double revolution_current, int distance_orbit, Position position, int id_orbit,int perimetre) {
        super(id, name, size, position,perimetre);
